...
public class AddLostItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference("lost_items_images");
                ...
                .addOnSuccessListener(taskSnapshot -> fileReference.getDownloadUrl().addOnSuccessListener(uri -> {
                    ...
                    db.collection("lost_items")
                            ...
                            .addOnFailureListener(e -> {
                                Toast.makeText(AddLostItemActivity.this, "Failed to add item: " + e.getMessage(), Toast.LENGTH_SHORT).show();
