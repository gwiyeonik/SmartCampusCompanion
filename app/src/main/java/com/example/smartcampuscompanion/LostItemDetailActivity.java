...
public class LostItemDetailActivity extends AppCompatActivity {
    ...
    private void loadItemDetails() {
        db.collection("lost_items").document(documentId).get()
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
                        editItemNameDetail.setText(documentSnapshot.getString("name"));
                        editItemLocationDetail.setText(documentSnapshot.getString("Last Seen location"));
    ...
    private void deleteFirestoreDocument() {
        db.collection("lost_items").document(documentId).delete()
    ...
    private void updateItem() {
        ...
        db.collection("lost_items").document(documentId).update(updatedItem)
                .addOnSuccessListener(aVoid -> {
