...
public class LostItemsListActivity extends AppCompatActivity implements LostFoundAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_view_lost_items_list);
        ...
        btnAddItem.setOnClickListener(v -> {
            startActivity(new Intent(LostItemsListActivity.this, AddLostItemActivity.class));
        });
    ...
    private void loadLostItems() {
        db.collection("lost_items").addSnapshotListener((value, error) -> {
            if (error != null) {
                // Handle error
                return;
            }
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(this, LostItemDetailActivity.class);
